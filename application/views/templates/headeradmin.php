                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a href="<?= base_url('Guru'); ?>" class="nav-link">Guru</a></li>
                                <li class="nav-item"><a href="<?= base_url('Tata-Usaha'); ?>" class="nav-link">Tenaga Pendidik</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link"><span>Galeri</span></a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><span>Ekstrakurikuler</span></a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a href="index-0.html" class="nav-link">Pramuka</a></li>
                                <li class="nav-item"><a href="index.html" class="nav-link">PMR</a></li>
